# go-ruby-images documentation

**Comprehensive pure-Go Ruby image library (MiniMagick/vips-style + chunky_png + go-images), CGO=0 — bound into rbgo**

`go-ruby-images/images` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `images`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-images/images`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `images`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`images`](https://github.com/go-ruby-images/images) | the library — Ruby's `images` in pure Go |
| [`docs`](https://github.com/go-ruby-images/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-images.github.io`](https://github.com/go-ruby-images/go-ruby-images.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-images/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-images/images](https://github.com/go-ruby-images/images).
